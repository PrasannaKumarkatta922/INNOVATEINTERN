...
//   const { register, handleSubmit } = useForm();
  const onSubmit = (data) => {
    ...
    const getInfo=()=>{
      ...
      toast("login success");
    axios.post(`http://localhost:5000/${selected.toLowerCase()}/auth/login`, {loginid,password})
        .then(result => {
            console.log(result)
  ...
  return (
    <div className="bg-white h-[100vh] w-full flex justify-between items-center">
      <img
        ...
        src="https://respin.iisc.ac.in/contributors/RGUKT%20RK%20Valley.jpeg"
        // src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR4dGbqfOqxjlCzi_PMlIYTo0ObNJXgh-WzKQ&s"
